...
const targetStr = `            <!-- MD. KAISAR ALAM -->
            <div class="team-member-card" style="background: #fff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.05); width: calc(33.333% - 20px); max-width: 380px; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                <div class="team-member-img-wrap" style="height: 380px; overflow: hidden;">
                    <img src="./assets/GALLERY/gallery%20homepage%20(2).jpeg"`;

const replacementStr = `            <!-- MD. KAISAR ALAM -->
            <div class="team-member-card" style="background: #fff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.05); width: calc(33.333% - 20px); max-width: 380px; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                <div class="team-member-img-wrap" style="height: 380px; overflow: hidden;">
                    <img src="./assets/images/team/kaisar.jpg"`;
...
if (normalizedContent.includes(normalizedTarget)) {
    ...
    console.log("SUCCESS: Kaisar image path successfully updated to ./assets/images/team/kaisar.jpg!");
} else {
    console.error("ERROR: Target Kaisar block not found in about.html.");
}
